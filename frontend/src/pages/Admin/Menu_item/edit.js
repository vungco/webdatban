...
const EditForm = ({ setisShowFormEdit,GetMenu_items,data,id }) => {
    ...
    axios.post(`http://localhost:8000/api/menu_items/${id}`, formdata, 
      {
        headers: {
            ...
            <div className="modal-content">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="mb-3">
                        ...
                        >
                            <option value={CategoryID} hidden>{CategoryName}</option>
                    ...
                    <div className="mb-3">
                        <label className="form-label">Chọn ảnh sản phẩm mới nếu bạn muốn thay</label>
                        <input
                            type="file"
                            name="img"
                            className="form-control"
